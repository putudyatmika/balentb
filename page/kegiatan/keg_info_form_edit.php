...
if ($cek>0) {
 ...
 if ($edit==1) {
?>
<legend>Edit Info Kegiatan</legend>
		...
		<div class="form-group">
			<label for="keg_spj" class="col-sm-2 control-label">Informasi Kegiatan</label>
				<div class="col-sm-8"> 
					<textarea cols="20" rows="5" name="keg_info" class="form-control ckeditor"><?php echo html_entity_decode($e->keg_info); ?></textarea>
				</div>
		</div>
		<div class="form-group">
