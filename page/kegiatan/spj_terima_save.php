...
$db = new db();
$conn = $db -> connect();
$sql_keg = $conn->query("insert into spj_detil(keg_id, spj_d_unitkerja, spj_d_tgl, spj_d_jumlah, spj_d_jenis, spj_d_dibuat_oleh, spj_d_dibuat_waktu, spj_d_diupdate_oleh, spj_d_ket) value('$keg_id', '$spj_d_unitkerja', '$spj_d_tgl', '$spj_d_jumlah', '$spj_d_jenis', '$created', '$waktu_lokal', '$created','$created')");
